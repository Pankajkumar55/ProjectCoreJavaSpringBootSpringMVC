...
/*CREATE OR REPLACE PROCEDURE P_GET_DOCTORS_BY_INCOME 
(
...
BEGIN
  ...
  OPEN DETAILS FOR
     select * from JPA_DOCTOR  where doctor_income>=startincome and doctor_income<=endincome;  
  
END P_GET_DOCTORS_BY_INCOME; */
