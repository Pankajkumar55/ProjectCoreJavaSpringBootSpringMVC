...
public class CrudRepositoryTestRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/*    try {
		  Doctor  doc1=new Doctor("suresh","MD",89991L,9999991L,"cardio");
		  Doctor  doc2=new Doctor("mahesh","MD",89992L,9999991L,"physio");
		  Doctor  doc3=new Doctor("karam","MD",89993L,99999981L,"nuero");
		  Doctor  doc4=new Doctor("mahi","MBBS",89991L,99999981L,"nuero");
		  Doctor  doc5=new Doctor("sahi","MD",89913L,99999981L,"ortho");
		  
		 List<Doctor>  list=List.of(doc1,doc2,doc3,doc4,doc5);  //java 9 feature giving immutable collection
		...
		*/
		/*   try {
		   String msg=docService.checkDoctorAvailabilityById(102);
		   System.out.println(msg);
		}
		catch(Exception e) {
		  e.printStackTrace();
		...
		*/
		...
		/*
				try {
					...
					List<Integer> ids = Arrays.asList(101, 102, 53, 451, null);
		...
		*/
		/*   try {
		   Optional<Doctor>  opt=docService.getDoctorById(152);
		   if(opt.isEmpty())
		...
		*/
		...
		/*   try {
		    Doctor doc=new Doctor(152,"suresh","MD",89999L,7777777L,"cardio");
		...
		*/
		/*try {
		String msg=docService.updateDoctorDetails(521, "MD-FRC London", 97899999L);
		System.out.println(msg);
		}
		catch(Exception e) {
		  e.printStackTrace();
		...
		/*  try {
		  String msg=docService.removeDoctorsByIds(List.of(303,304,305,190,109));
		  System.out.println(msg);
		}
		 catch(Exception e) {
		   e.printStackTrace();
